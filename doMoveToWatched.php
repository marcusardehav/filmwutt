...
$command = "DELETE FROM towatch WHERE filmid='" . $filmid . "' LIMIT 1";
$result = mysql_query($command, $connection);

$command2 = "INSERT INTO watched(filmid, title, poster, runtime, imdb, releasedate) VALUES('$filmid', '$title', '$poster', '$runtime', '$imdb', '$releasedate')";
